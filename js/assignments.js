...
function assignmentToString(assignment) {
    return (`${assignment.title} / ${assignment.description} / ${assignment.subDateTime} / ${assignment.oralMark} / ${assignment.totalMark}`);    
}
...
function submit (event) {
    ...
    let myAssignment = new Assignment (assTitle.value, assDescription.value, assSubDateTime.value,assOralMark.value,assTotalMark.value);
...
function update(event) {
    ...
    assignments[this.assignmentIndex] =new Assignment(assTitle.value, assDescription.value,assSubDateTime.value,assOralMark.value,assTotalMark.value);
